#ifndef _SDK_BASETYPES_
#define _SDK_BASETYPES_
...
template <typename T>
inline T AlignValue(T val, unsigned long long alignment){
	return (T)(((unsigned long long)val + alignment - 1) & ~(alignment - 1));
}
